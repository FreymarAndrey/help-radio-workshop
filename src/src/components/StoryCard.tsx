...
export function StoryCard({ story, index = 0 }: StoryCardProps) {
  return (
    ...
    >
      <div className="relative min-h-56 overflow-hidden bg-linear-to-br from-subtitle/10 to-accent/10">
        <motion.img
        ...
        />
        <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-ink/30 via-transparent to-transparent opacity-60" />
      </div>
